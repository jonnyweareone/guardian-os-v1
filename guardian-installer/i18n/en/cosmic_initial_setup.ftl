...
guardian-auth-page = Parent Authentication
    .sign-in-description = Sign in with your Guardian account to continue setting up this device.
...
birth-date-placeholder = YYYY-MM-DD
...
guardian-sync-page = Settings Sync
    ...
    .description = Enable Guardian Sync to keep your desktop settings, themes, and preferences synchronized across all your Guardian OS devices.
