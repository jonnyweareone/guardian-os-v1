...
# NOTE: We do NOT modify greetd or live session configs!
# Pop!_OS already has a working live session via casper.
# The live user is created automatically by casper at boot.
# We only inject our packages and branding, nothing else.
